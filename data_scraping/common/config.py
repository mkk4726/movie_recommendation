...
class Config:
    ...
    MAX_COMMENTS_PER_MOVIE: int = 500  # None means no limit
    ...
    XPATHS: Dict[str, str] = field(default_factory=lambda: {
        ...
        "comment_likes_template": '/html/body/main/div[1]/section/div[2]/ul/li[{i}]/article/ul/li[1]/button/span',
        "comment_spoiler_button_template": '/html/body/main/div[1]/section/div[2]/ul/li[{i}]/article/a[2]/p/button',
        
        # User ratings page (dynamic index) - Updated 2025-10-23 for new page structure (Playwright compatible)
        "user_movie_id_template": '/html/body/main/div[1]/section/section/ul/li[{i}]/a',
        "user_movie_name_template": '/html/body/main/div[1]/section/section/ul/li[{i}]/a/div[2]/div[1]',
        "user_movie_rating_template": '/html/body/main/div[1]/section/section/ul/li[{i}]/a/div[2]/div[2]',
    })

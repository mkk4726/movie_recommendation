...
class NERConfig:
    ...
    allowed_models: list = field(
        default_factory=lambda: ["Qwen/Qwen2.5-1.5B-Instruct", "Qwen/Qwen2.5-3B-Instruct", "Qwen/Qwen2.5-7B-Instruct"]
    )
    ...
    def from_yaml(cls, yaml_path: Optional[str] = None) -> "NERConfig":
        ...
        if yaml_path is None:
            yaml_path = Path(__file__).parent.parent.parent.parent.parent.parent / "config" / "modeling.yaml"
        else:

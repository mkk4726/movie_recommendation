...
def get_data(movie_id):
    ...
    try:
        ...
        title = None
    try:
        movie_info = tree.xpath('//*[@id="root"]/div[1]/section/div/div[2]/div/div/div[1]/div[2]/div/div[2]/text()')[
            0
        ].split("·")
    ...
    try:
        movie_info2 = tree.xpath('//*[@id="root"]/div[1]/section/div/div[2]/div/div/div[1]/div[2]/div/div[3]/text()')[
            0
        ].split("·")
    ...
    while True:
        try:
            name = tree.xpath(f'//*[@id="content_credits"]/section/div[1]/ul/li[{i}]/a/div[2]/div[1]/div[1]/text()')[
                0
            ].replace("/", " ")
            role = tree.xpath(f'//*[@id="content_credits"]/section/div[1]/ul/li[{i}]/a/div[2]/div[1]/div[2]/text()')[
                0
            ].replace("/", " ")
    ...
    try:
        synopsis = (
            tree.xpath(
                '//*[@id="root"]/div[1]/section/div/div[2]/div/div/div[2]/section[1]/div[2]/section[3]/p/text()'
            )[0]
            .replace("\n", " ")
            .replace("/", " ")
        )
        ...
        synopsis = None
    try:
        avg_rating = tree.xpath(
            '//*[@id="root"]/div[1]/section/div/div[2]/div/div/div[2]/section[1]/div[2]/section[1]/div[2]/div/div[1]/text()'
        )[0]
    except Exception:
        avg_rating = None
    try:
        n_rating = extract_number(
            tree.xpath(
                '//*[@id="root"]/div[1]/section/div/div[2]/div/div/div[2]/section[1]/div[2]/section[1]/div[2]/div/div[2]/text()'
            )[1]
        )
    except Exception:
        n_rating = None
...
if __name__ == "__main__":
    ...
    # 뽑아야하는 movie id값
    movie_ids = list(
        set(custom_movie_rating_df["MovieID"]) - set(movie_info.loc[movie_info["Title"] != "None", "MovieID"])
    )

...
if __name__ == "__main__":
    ...
    parser.add_argument("--limit", type=int, default=None, help="Maximum number of items to scrape per task")
    parser.add_argument("--delay", type=float, default=2.0, help="Delay between requests in seconds")
    parser.add_argument("--skip-movie-info", action="store_true", help="Skip movie info scraping")
    parser.add_argument("--skip-comments", action="store_true", help="Skip movie comments scraping")
    parser.add_argument("--skip-ratings", action="store_true", help="Skip custom ratings scraping")

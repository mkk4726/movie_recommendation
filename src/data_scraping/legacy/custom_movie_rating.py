...
def get_data(custom_id):
    ...
    while True:
        try:
            ...
            movie_id = tree.xpath(
                f'//*[@id="root"]/div[1]/section/section/div[1]/section/div[1]/div/ul/li[{i}]/a/@href'
            )[0].split("/")[-1]
            movie_name = tree.xpath(
                f'//*[@id="root"]/div[1]/section/section/div[1]/section/div[1]/div/ul/li[{i}]/a/div[2]/div[1]/text()'
            )[0].replace("/", "")
            movie_rate = extract_number(
                tree.xpath(
                    f'//*[@id="root"]/div[1]/section/section/div[1]/section/div[1]/div/ul/li[{i}]/a/div[2]/div[2]/text()'
                )[0]
            )

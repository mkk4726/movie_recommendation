...
def debug_movie_info():
    ...
    with browser_manager.get_page() as page:
        ...
        print(
            f"📝  SYNOPSIS: {extracted_data.get('movie_synopsis', 'Not found')[:100]}..."
            if extracted_data.get("movie_synopsis") and len(extracted_data.get("movie_synopsis", "")) > 100
            else f"📝  SYNOPSIS: {extracted_data.get('movie_synopsis', 'Not found')}"
        )

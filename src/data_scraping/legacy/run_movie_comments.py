...
def main(
    limit: Optional[int] = None, delay: float = 2.0, max_comments: Optional[int] = None, config: Optional[Config] = None
) -> None:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--limit", type=int, default=None, help="Maximum number of movies to scrape comments for")
    parser.add_argument("--delay", type=float, default=2.0, help="Delay between requests in seconds")
    parser.add_argument(
        "--max-comments", type=int, default=None, help="Maximum number of comments per movie (None for all)"
    )

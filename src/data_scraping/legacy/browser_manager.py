...
class BrowserManager:
    ...
    def _create_context(self, browser: Browser) -> BrowserContext:
        ...
        if auth_file.exists():
            ...
            context = browser.new_context(user_agent=self.config.USER_AGENT, storage_state=str(auth_file))
        else:
    ...
    def extract_xpath_text(
        self, tree: etree._Element, xpath: str, index: int = 0, default: Optional[str] = None
    ) -> Optional[str]:
        """

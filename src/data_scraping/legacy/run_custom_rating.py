...
def main(limit: Optional[int] = None, delay: float = 2.0, config: Optional[Config] = None) -> None:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--limit", type=int, default=None, help="Maximum number of users to scrape ratings for")

...
def main():
    ...
    print("\n[2] 영화 데이터 로드")
    movies_path = (
        Path(__file__).parent.parent.parent.parent.parent.parent / "data_scraping" / "data" / "ml-32m" / "movies.csv"
    )
    ...
    # 4. 검색 테스트
    print("\n[4] 검색 테스트")
    test_queries = ["toy story", "adventure fantasy", "comedy romance", "animation children"]

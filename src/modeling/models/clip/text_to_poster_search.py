...
class TextToPosterSearchPipeline:
    ...
    def _load_language_modules(self):
        ...
        if self.language_detector is None or self.translator is None:
            ...
            try:
                ...
                from models.language import KoreanEnglishTranslator, LanguageDetector
    ...
    def search(
        ...
        logger.info(
            f"🔍 텍스트-포스터 검색: '{query}' (top_k={top_k}, filter_ids={len(filter_movie_ids) if filter_movie_ids else 'None'})"
        )

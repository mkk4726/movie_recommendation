...
ACTIVITY_LOGS_DIR = PROJECT_ROOT / "activity_logs"
...
class UserActivityLogger:
    ...
    def log_search(
        ...
        activity_type = ActivityType.POSTER_SEARCH if search_type == "poster" else ActivityType.SEARCH
    ...
    def log_rating(self, request: Request, movie_id: str, rating: float, action: str = "add") -> None:
        """
        Log a rating event.
    ...
    def log_view(self, request: Request, movie_id: str, view_context: Optional[str] = None) -> None:
        """
    ...
    def log_recommendation(
        self, request: Request, recommendation_type: str, result_movie_ids: List[str], user_id: Optional[str] = None
    ) -> None:
        """

...
def get_text_to_poster_pipeline():
    ...
    try:
        ...
        from modeling.models.clip.text_to_poster_search import TextToPosterSearchPipeline
        
        # 파이프라인 생성
        _text_to_poster_pipeline = TextToPosterSearchPipeline(model_key="jina-clip")
        
        logger.info("✅ TextToPosterSearchPipeline 로드 완료")
        return _text_to_poster_pipeline
